...
- **Top 15 Finalist** — EvolvX Projectathon 2025, MNIT Jaipur  
  *(National-level innovation competition)*

- **Selected Mentor** — GirlScript Summer of Code (GSSoC '25)  
  *(Mentored contributors in open-source development)*

- **Co-Author** — IEEE-format Research Paper on Few-Shot Learning  
  *(Research focused on low-data learning techniques)*

- **Selected** — Google Student Ambassador (2024–25)  
